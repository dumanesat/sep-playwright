...
Feature: Program start dates and Refund dates
    ...
    Background:
        Given User is on enrollment page
    Scenario: Program Start date and refund dates must be displayed in step one in Test Automation with Selenium Program.
        Then Program Start Date is displayed
        And  Refund Date is displayed
        And Program start date is correct
        And Refund date is correct
